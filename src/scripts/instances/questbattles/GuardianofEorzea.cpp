...
public:
  ...
  void onInit( QuestBattle& instance ) override
  {
    ...
    instance.addEObj( "√óËç∑Ëªä", 2005952, 0, 5899567, 4, { -222.920395f, -3.614243f, -542.295227f }, 1.000000f, -0.306771f, 0); 
    instance.addEObj( "√óÊ®Ω1", 2005953, 0, 5899569, 4, { -235.755096f, -4.371367f, -542.365723f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "√óÊ®Ω2", 2005954, 0, 5899570, 4, { -235.018204f, -4.291595f, -541.160095f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "√óÊµ∑Ë≥ä„ÉÜ„Éº„Éñ„É´", 2005956, 0, 5899571, 4, { 243.274094f, 0.356674f, -562.477478f }, 1.000000f, -0.738497f, 0); 
    instance.addEObj( "√óÊú¨„ÅÂ±±", 2005957, 0, 5899572, 4, { 243.112198f, 1.160357f, -561.931213f }, 1.000000f, 1.199492f, 0); 
    ...
    instance.addEObj( "√ó", 2006449, 0, 5960928, 4, { -661.219971f, -2.933044f, -367.503601f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "√ó_1", 2006450, 0, 5960932, 4, { -570.468811f, -3.988342f, -334.747894f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "√ó_2", 2006451, 0, 5960935, 4, { -462.368500f, -4.007370f, -289.339386f }, 1.000000f, 0.000000f, 0); 
